...
const initialState = {
  ...
  colors: ["No color" , "No color it is service","Black", "Brown", "Silver", "White", "Blue", "green", "yellow"],
  brands: ["No Brand" ,"No Brand it is local service","Apple", "Samsung", "Microsoft", "Lenovo", "ASUS" ,"Desktop", "canon","Boat","fortune" ],
  color: "",
  brand: "",
};
